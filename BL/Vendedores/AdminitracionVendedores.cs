...
public class AdministracionVendedores {
    ...
    public async Task<VendedorResponse> ActualizarVendedor( Guid? id, VendedorRequest vendedorRequest ) {
        ...
        if( id != null && vendedorRequest.Nombre != null && vendedorRequest.Apellidos != null && vendedorRequest.RFC != null && 
            ...
            using( var conexion = new SqlConnection( ContextDB.CadenaConexion ) ) {
                ...
                comando.Parameters.AddWithValue( "@IdDatosGenerales", vendedorRequest.IdDatosGenerales );
                comando.Parameters.AddWithValue( "@Nombre", vendedorRequest.Nombre );
                comando.Parameters.AddWithValue( "@Apellidos", vendedorRequest.Apellidos );
                comando.Parameters.AddWithValue( "@RFC", vendedorRequest.RFC );
                comando.Parameters.AddWithValue( "@Direccion", vendedorRequest.Direccion );
    ...
    public async Task<VendedorResponse> EliminarVendedor( Guid? id ) {
        VendedorResponse resultado = new VendedorResponse();
    ...
    public async Task<List<VendedorResponse>> ListarFiltroVendedores( string nombre ) {
        ...
        if( nombre != "" )
        {
            ...
            resultado.Add( new VendedorResponse {
